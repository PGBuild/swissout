  ...
  return (
    <div className="landing">
      ...
      <div className="landing-cards">
        <div className="landing-card" onClick={onLogin}>
        ...
        <div className="landing-card" onClick={onRegister}>
          <span className="lc-icon" style={{animationDelay:"0.5s"}}>✨</span>
...
export default function App() {
  ...
  return (
    <>
      <style>{S}</style>
      {view === "landing"   && <Landing onLogin={() => setView("login")} onRegister={() => setView("register")} onAdmin={() => setView("admin")} />}
